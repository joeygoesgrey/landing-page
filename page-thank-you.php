...
<div class="container mx-auto mt-20 p-4 text-center">
    <h1 class="md:text-4xl text-2xl  font-bold mb-4">Congratulations!</h1>
    <p class="text-lg  md:px-8">You have been able to access your free guide. Thank you for submitting your details. </p>
...
<?php echo do_shortcode('[confetti-fall-animation delay="0.2" time="25"]'); ?>